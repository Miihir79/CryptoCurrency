package com.mihir.cryptocurrency.presentation.coin_detail.components
...
import com.mihir.cryptocurrency.presentation.Screen
import com.mihir.cryptocurrency.presentation.coin_detail.CoinDetailViewModel
import com.mihir.cryptocurrency.presentation.coin_list.CoinListViewModel
            ...
            LazyColumn(modifier = Modifier.fillMaxSize(), contentPadding = PaddingValues(20.dp)){
                item {
                    ...
                    horizontalArrangement = Arrangement.SpaceBetween){
                        ...
                        Text(
                            text = if (coin.isActive) "Active" else "incative",
