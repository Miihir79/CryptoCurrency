...
import com.mihir.cryptocurrency.domain.use_cases.get_list.GetListUserCase
...
@HiltViewModel
class CoinListViewModel @Inject constructor(private val getCoinsUseCase: GetListUserCase):ViewModel() {
